...
for smoothingFactor = [40]
    for dataFactor = [400]
        for horzNeighborMaskWeight = [30]
            for verticalNeighborMaskWeight = [2]
                ...
                minLabel = 60;
                maxLabel = 150;
                f_l = 6.1762    ;        % left camera is ir, calibrated 8/25/2016
                        ...
                        for i = 1:numCols
                            for j = 1: numLabels
                                ...
                                %if i + disparity <= numCols
                                    ...
                                    leftPixel_1 = 320+x_l/.006;        % this is a fractional pixel
                                    %rp(j) = rightPixel_1;
                                    if (leftPixel_1 < 1)
                                        dataCost(j, site) = 2;
